...
* 3 Nodes:
  ...
  * scripts/webcam_view.py: Subscribes to Image medssages from video_frames_processed Topic. Utilising ImageZMQ sends images over network to IP defined in ImageSender method.
 * Additional:
...
![picture_alt](https://github.com/systemvaz/ROS_Packages/blob/master/camera/src/receiver.py)
